...
namespace Test1 {
    public sealed class Hit : IState {
        ...
        public void ReplaceAt(UInt16 tag, WireType wireType, Reader reader, bool shouldNotify) {
            switch (tag) {
                case 0: this.BeforeAttacking = this.Notify(Action.Deserialize(reader.Nested(), this.Path.Nested(0)), this.BeforeAttacking, shouldNotify, beforeAttackingListeners); break;
                case 1: this.BeforeDamaging = this.Notify(Action.Deserialize(reader.Nested(), this.Path.Nested(1)), this.BeforeDamaging, shouldNotify, beforeDamagingListeners); break;
                case 2: this.Damaging = this.Notify(Action.Deserialize(reader.Nested(), this.Path.Nested(2)), this.Damaging, shouldNotify, damagingListeners); break;
                case 3: this.AfterDamaging = this.Notify(Action.Deserialize(reader.Nested(), this.Path.Nested(3)), this.AfterDamaging, shouldNotify, afterDamagingListeners); break;
                case 4: this.AfterAttacking = this.Notify(Action.Deserialize(reader.Nested(), this.Path.Nested(4)), this.AfterAttacking, shouldNotify, afterAttackingListeners); break;
